...
$(function(){
  // initialise tha AJAX library
    ...
    {cache: false,
      ...
      error: onAjaxError,
      type: 'POST',
      url: 'admin/bibharvest/oaiharvestadmin.py/get_entries_fragment'
    }
  );
});
*/
...
function createPagerPage(baseIdentifier, pageNumber){
  ...
  page.setAttribute("class", "bibHarvestPagerPage");
...
function adjustButtonsVisibility(pagerPrefix){
  ...
  $("#" + pagerPrefix).find(".bibHarvestPagerNavigationLink").
      addClass("bibHarvestPagerHiddenNavigationLink");
  ...
  for (i = (currentPage - visibilityRadius); i < (currentPage +
	...
	removeClass("bibHarvestPagerHiddenNavigationLink");
  }
...
function chooseVisiblePage(pagerPrefix, pageNumber){
  $("#" + pagerPrefix).find(".bibHarvestPagerPage").addClass("bibHarvestPagerHiddenPage");
  $("#" + pagerPrefix.toString() + "_" + pageNumber.toString()).removeClass("bibHarvestPagerHiddenPage");
  $("#" + pagerPrefix).find(".bibHarvestPagerCurrentPageLink").removeClass("bibHarvestPagerCurrentPageLink");
  $("#" + pagerPrefix.toString() + "_btn_" + pageNumber.toString()).addClass("bibHarvestPagerCurrentPageLink");
...
function createPageChoiceBar(baseIdentifier, pages){
  ...
  previousPageBtn.setAttribute("class", "bibHarvestPagerNavigationLink");
  ...
  for (pageIndex in pages){
    ...
    pageChoiceBtn.setAttribute("class", "bibHarvestPagerNavigationLink");
  ...
  nextPageBtn.setAttribute("class", "bibHarvestPagerNavigationLink");
  ...
  lastPageBtn.setAttribute("class", "bibHarvestPagerNavigationLink");

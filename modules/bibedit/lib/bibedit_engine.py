...
from invenio.config import CFG_SITE_LANG, CFG_BIBEDIT_INTEGRATE_WITH_BIBCIRC
...
def perform_request_record(req, request_type, recid, uid, data, ln=CFG_SITE_LANG):
    ...
    if request_type == 'newRecord':
        ...
        if record_status == 0:
            ...
            can_have_copies = (CFG_BIBEDIT_INTEGRATE_WITH_BIBCIRC == True) and \
                can_record_have_physical_copies(recid)
